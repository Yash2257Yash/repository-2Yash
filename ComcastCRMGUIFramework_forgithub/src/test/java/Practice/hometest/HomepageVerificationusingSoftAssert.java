...
public class HomepageVerificationusingSoftAssert {
...
//		String ExpectedPage = "Home Page";
		...
		assertsoft.assertEquals("Home", "HomePage");
		System.out.println("after assertfail HI");
		System.out.println(" after assertfail Hello");
